...
export default function HomeScreen() {
  ...
  const firstName =
    profileFirstName || (name ? name.split(" ")[0] : "Explorer");
  ...
  const cardStyle = useMemo(
    () => [styles.card, { backgroundColor: surface }],
    [surface],
  );
  ...
  const nextQuest = quests && quests.at(0);
    ...
    <>
      <ThemedView style={containerStyle}>
        ...
        >
          <View style={styles.headerCard}>
            ...
            {userTeam && (
              <View style={styles.teamInfo}>
                <View
                  style={[styles.teamChip, { borderColor: userTeam.color }]}
                >
                  <View
                    style={[
                      styles.teamDot,
          ...
          {nextQuest && <QuestView quest={nextQuest} />}
              ...
              {teams
                ...
                .map((item, index) => (
                  ...
                  >
                    ...
                    <ThemedText
                      style={[styles.activityTime, { color: subtleText }]}
                    >
                      {item.timeAgo}
                    </ThemedText>
                  </View>
